...
for cont_passos=1:passos
    for j=1:round(gait/taxa) 
        Qc(round(gait/taxa)*(cont_passos-1)+j+1,1)=ang_q*sin(pi*taxa*j/gait)*(-1)^(1-mod(cont_passos,2));
        Qc(round(gait/taxa)*(cont_passos-1)+j+1,2)=ang_q*sin(pi*taxa*j/gait)*(-1)^(1-mod(cont_passos,2));
        Qc(round(gait/taxa)*(cont_passos-1)+j+1,3)=ang_q*sin(pi*taxa*j/gait)*(-1)^(1-mod(cont_passos,2));
        Qc(round(gait/taxa)*(cont_passos-1)+j+1,4)=ang_q*sin(pi*taxa*j/gait)*(-1)^(1-mod(cont_passos,2));
...
%    end
    ...
    Qr(j+(round(gait/taxa)+round(gait_c/taxa))*(cont_passos-1),1)=Qc(round(gait/taxa)*(cont_passos-1)+j+1,1);
    Qr(j+(round(gait/taxa)+round(gait_c/taxa))*(cont_passos-1),5)=QrQc(round(gait/taxa)*(cont_passos-1)+j+1,2);
    Qr(j+(round(gait/taxa)+round(gait_c/taxa))*(cont_passos-1),8)=Qc(round(gait/taxa)*(cont_passos-1)+j+1,3);
    Qr(j+(round(gait/taxa)+round(gait_c/taxa))*(cont_passos-1),12)=Qc(round(gait/taxa)*(cont_passos-1)+j+1,4);
