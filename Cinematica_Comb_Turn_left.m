if 1 %0 para rodar alg aprendizado
    ...
    ang_q=corr_ang_q*17; %inclinaço lateral
...
if graf
    ...
    if csv
        ...
        fwrite(fileID,[saidainv(primeiro+1:primeiro+meio); saidainv(primeiro+meio+intervalo+1:primeiro+meio+intervalo+fim)],'int16','l');
        fclose(fileID);
